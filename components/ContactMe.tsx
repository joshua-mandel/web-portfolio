...
export default function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    window.location.href = `mailto:jmandelmvp@gmail.com?subject=${formData.subject}&body=${formData.message}&body=Hi, my name is ${formData.name}. ${formData.message} (${formData.email})`
  };
